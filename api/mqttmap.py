...
SOLIXMQTTMAP = {
    ...
    "SHEMP3": {
     ...
     "A1790P": {
        ...
        "0405": {
            "topic": "param_info",
            "a4": {"name": "remaining_usage_time", "factor": 0.1},
            ...
            "ac": {"name": "switch_12v_dc_output_power?"},
            "ad": {"name": "battery_soc_total"},
            "ae": {"name": "photovoltaic_power"},
            "af": {"name": "pv_1_power"},
            "b0": {"name": "pv_2_power"},
            "b1": {"name": "charging_power"},
            ...
            "cc": {"name": "device_sn"},
            "cd": {"name": "ac_input_limit"},
            "d9": {"name": "light_status"},
            "fe": {"name": "msg_timestamp"},
        },
    },
}
